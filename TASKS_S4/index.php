<?php
/*
создать массив, в котором будет описываться опыт работы (правая верхняя часть сайта). 
...
$experience = [
    [
        ...
        Voluptas corrupti reprehenderit cumque ex non quis, culpa illum, iste.'
    ],
    [
        'position' => 'Project manager',
        'period' => 'apr 2010 - may 2013',
        'desription' => 'Lorem ipsum dolor sit amet consectetur adipisicing elit. 
        Voluptas corrupti reprehenderit cumque ex non quis, culpa illum, iste.'
    ],
    [
                ...
                <?php for ($i=0; $i < count($experience); $i++): ?>
                    ...
                    <div class="w3-container w3-card w3-white w3-margin-bottom">
                        ...
                        <div class="w3-container">
                            ...
                            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>J<?=$experience[$i]['period'];?></h6>
                            <p><?=$experience[$i]['desription'];?></p>
                            <hr>
                        </div>
